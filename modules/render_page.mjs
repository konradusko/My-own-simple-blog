...
export const render_page = ({
    ...
    try {
        const page = ejs.render(fs.readFileSync(path.join(__dirname,'template',Module_config.getConfig().template,template),'utf-8').toString(),{data:object,template:Module_config.getConfig().template_data})
